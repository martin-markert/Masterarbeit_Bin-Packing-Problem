...
if __name__ == '__main__':
    ...
    # for boxes, rotation_constraints in zip(box_array_list, rotation_constraints_list):
    #     inject_fixed_pallet_boxes(boxes, rotation_constraints)

    for run_index, (boxes, rotation_constraints) in enumerate(zip(box_array_list, rotation_constraints_list)):
        inject_fixed_pallet_boxes(boxes, rotation_constraints)
