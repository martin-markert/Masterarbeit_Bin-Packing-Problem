...
class Parameters():
    def __init__(self):
        ...
        '''
        self.save_dir    = "{:d}_{:d}_{:d}_{:d}_{:d}_{:d}".format(self.bin_size_x, self.bin_size_y, self.bin_size_z, self.box_num, int(self.min_factor), int(self.max_factor))
    ...
    def initialise(self):
        ...
        if not os.path.exists("save"):                              # Is there a folder to safe the stuff? No? Well then let us create one
            os.makedirs("save")
